...
SECRET_KEY = 'django-insecure-ilqab9jta&r--djq0#l!&8jd_)d3&gvf+t!wo)=dki$813qq-*'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'console_warning': {
            ...
            'class': 'logging.StreamHandler',
            'formatter': 'format_warning_err_mail'
        },
        'console_error': {
            'level': 'ERROR',
            'filters': ['require_debug_true'],
    ...
    'loggers': {
        'django': {
            'handlers': ['console_debug', 'console_warning', 'console_error', 'file_general', 'file_errors',],
            'level': 'DEBUG',
            'propagate': True,
